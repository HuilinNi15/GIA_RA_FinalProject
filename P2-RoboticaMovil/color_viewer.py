...
class color_viewer:
    def __init__(self) -> None:
        ...
        self.pixel_count_threshold = 4000# 100000 # 1080 * 1920 // 10 ####################33 ajustar depen el tamany de la imatge
        self.step = 1 
    ...
    def crop_image(self):
        ...
        cropped_image = self.image[(height)//2+descentre:(height), width//5:4*width//5] # podem pillar nomes la meitat amunt o avall tipo el terra o no
