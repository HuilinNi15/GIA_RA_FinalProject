...
vectors = [
    ("REY BLANCO Region Inicial", np.array([138.55, -57.06, 51.30, -93.70, -81.20, 319.52])),
    ("REY BLANCO Region Final", np.array([146.63, -56.59, 46.99, -85.93, -83.68, 327.95])),
    ("REY BLANCO Grasp Inicial", np.array([138.55, -56.19, 67.36, -110.64, -81.22, 319.58])),
    ("REY BLANCO Grasp Final", np.array([146.63, -56.58, 65.98, -104.93, -83.70, 328.01])),
    ("REY NEGRO Region Inicial", np.array([147.08, -84.58, 87.67, -97.89, -84.51, 327.98])),
    ("REY NEGRO Region Final", np.array([138.57, -80.82, 74.93, -81.57, -89.77, 321.06])),
    ("REY NEGRO Grasp Inicial", np.array([147.08, -81.87, 100.86, -113.80, -84.53, 328.04])),
    ("REY NEGRO Grasp Final", np.array([138.58, -79.16, 94.80, -103.10, -89.78, 321.14])),
    ("CABALLO BLANCO Region Inicial", np.array([127.51, -53.28, 39.86, -75.53, -86.83, 307.45])),
    ("CABALLO BLANCO Region Final", np.array([142.99, -66.96, 59.86, -86.26, -83.95, 325.10])),
    ("CABALLO BLANCO Grasp Inicial", np.array([127.51, -54.71, 59.59, -93.83, -86.83, 307.52])),
    ("CABALLO BLANCO Grasp Final", np.array([147.00, -65.88, 79.12, -106.61, -83.97, 325.17])),
    ("CABALLO NEGRO Region Inicial", np.array([147.08, -84.58, 87.67, -97.89, -84.51, 327.98])),  # Igual que el del rey negro
    ("CABALLO NEGRO Region Final", np.array([132.45, -65.21, 54.79, -74.08, -92.50, 312.87])),
    ("CABALLO NEGRO Grasp Inicial", np.array([147.08, -81.87, 100.86, -113.80, -84.53, 328.04])),  # Igual que el del rey negro
    ("CABALLO NEGRO Grasp Final", np.array([132.46, -65.59, 73.19, -92.09, -92.51, 312.94]))
]
